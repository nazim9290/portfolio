      ...
      <div id="contact" className="container section">
        ...
        <div className="row contacts">
          <div className="col-md-3 col-lg-4">
            <div className="contacts__list">
              <dl className="contact-list">
                <dt>Phone:</dt>
                <dd>
                  <a href="tel:82344563333">8 (234) 555-33-69</a>
                </dd>
                <dt>Skype:</dt>
                <dd>
                  <a href="skype:live:hellorafiul">live:hellorafiul</a>
                </dd>
                <dt>Email:</dt>
                <dd>
                  <a href="mailto:rafi@dsaenthusiast.codes">
                    rafi@dsaenthusiast.codes
                  </a>
                </dd>
              </dl>
            </div>
          ...
          <div className="contacts__social col-md-3 pt-4 pt-md-0">
            <ul>
              <li>
                <a href="https://github.com/hellorafiul" target="_blank">
                  <i className="fa fa-github"></i> GitHub
                </a>
              </li>
              <li>
                <a
                  href="https://www.linkedin.com/in/hellorafiul/"
                  target="_blank"
                >
              ...
              <li>
                <a href="https://www.facebook.com/heyrafiul/" target="_blank">
                  <i className="fa fa-facebook-square"></i> Facebook
                </a>
              </li>
              <li>
                <a
                  href="https://www.instagram.com/hellorafiul/"
                  target="_blank"
                >
          ...
          <div className="footer ps-md-5 ms-md-5 mt-5">
            <p>@copy; 2021 Md Nazim Uddin. All Rights Reserved</p>
          </div>
        </div>
      </div>
    </div>
