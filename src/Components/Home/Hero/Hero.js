...
import myImg from '../../../img/nazim.jpg';
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-8 text-white hero-details" data-aos="fade-up"
            data-aos-duration="500">
            <p className="personal-profile__name">Md Nazim Uddin</p>
            <p className="personal-profile__work">I'm <span style={{ fontWeight: 'bold' }}>
              {/* Style will be inherited from the parent element */}
              <Typewriter
                words={['A MERN Stack Web Developer ⚛', 'A Self Believer ❤️']}
                loop={5}
                cursor
                cursorStyle='_'
                typeSpeed={50}
            ...
            <div className="personal-profile__social">
              <a href="https://github.com/hellorafiul" target="_blank"><i className="fa fa-github"></i></a>
              <a href="https://www.linkedin.com/in/hellorafiul/" target="_blank"><i className="fa fa-linkedin-square"></i></a>
              <a href="https://www.facebook.com/heyrafiul/" target="_blank"><i className="fa fa-facebook-square"></i></a>
              <a href="https://www.instagram.com/hellorafiul/" target="_blank"><i className="fab fa-instagram"></i></a>
            </div>
          </div>
        </div>
      </div>
